...
```{r fig7, eval = T, fig.show="hold", out.width = "80%", fig.align='center', fig.cap = "Terrain derivatives computed"}
...
```{r fig8, eval = T, fig.show="hold", out.width = "50%", fig.align='center', fig.cap = "Loss graph and Results subset for the first model"}
```
...
```{r fig9, eval = T, fig.show="hold", out.width = "50%", fig.align='center', fig.cap = "Loss graph and Results subset for the second model"}
```
...
```{r fig10, eval = T, fig.show="hold", out.width = "50%", fig.align='center', fig.cap = "Loss graph and Results subset for the third model"}
```
...
```{r fig11, eval = T, fig.show="hold", out.width = "100%", fig.align='center', fig.cap = "Distribution of Confidence values for the detected objects according to the padding size and model"}
...
```{r fig12, eval = T, fig.height = 2, fig.show="hold", out.width = "90%", fig.align='center', fig.cap = "Spatial distribution of detected objects by model"}
tmap_mode("plot")
...
```{r fig13, eval = T, fig.height = 3, fig.show="hold", out.width = "100%", fig.align='center', fig.cap = "Spatial distribution of detected objects by padding size"}
...
```
```{r fig14, eval = T, fig.show="hold", out.width = "80%", fig.align='center', fig.cap = "Number of detected objects by padding size"}
ggplot(detected_gullies_bestmodel) +
  geom_bar(aes(as.factor(padding))) +
  labs(y = "No. of detected objects", x = "Padding size")

```
```{r fig15, eval = T, fig.show="hold", out.width = "80%", fig.align='center', fig.cap = "Area of detected objects"}
